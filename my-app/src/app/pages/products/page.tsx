  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-20">
        <ProductSectionComp products={ProductSection3} cols="4"/>
        <ProductSectionComp products={ProductSection4} cols="4"/>
        <ProductSectionComp products={ProductSection5} cols="4"/>
      </div>
    </div>
    <ProductsHero/>
    <Footer/>
