...
const BottomHeader = () => {
    return (
        <div className="flex items-center px-[15.625%] h-[84px] w-full 
    bg-[#F0F2F3] justify-between">
            <div className="flex gap-1">
                <Image src="/logo.png" height={40} width={40} alt="Logo"
                />
                <h2 className="font-medium font-inter text-[26px]">Comforty</h2>
            </div>
            <Link href="/components/cart" className="flex items-center h-11 w-[10.333%] bg-[#fff] 
            rounded-[8px] px-3 gap-2">
                ...
                <div className="flex h-5 w-5 rounded-full bg-[#173917]
